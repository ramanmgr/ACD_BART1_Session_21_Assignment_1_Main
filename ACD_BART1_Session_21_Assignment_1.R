...
data.iris= read.csv("D:/BIG DATA/DATA ANALYTICS WITH R, EXCEL & TABLEAU/21 MODEL DEPLOYMENT/iris.csv") # read iris dataset
...
boxplot(data.iris[,-5])
plot(SepalLengthCm~SepalWidthCm,data.iris)
